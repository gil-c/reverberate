...
def build(
    ...
    *,
    ...
    # One gain over every variant and every receiver at once: a gain per file
    # would make a dead 60 ms response as loud as a full one.
    gain = audio.peak_gain(*[block for group in wet for block in group])
