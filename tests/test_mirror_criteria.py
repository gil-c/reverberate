...
from reverberate.mirror import criteria
...
from reverberate.mirror.criteria import judge
...
def test_module_exports_are_what_the_stage_will_import() -> None:
    for name in ("judge", "aggregate", "detect_reflections", "tail_statistics"):
        assert name in criteria.__all__
